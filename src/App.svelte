...
<header>
  ...
  <img src="/UIProject_4/src/assets/childrens-logo-new.png" alt="Cincinnati Children's Logo" style="position: relative; left: 60px;">
</header>
<div class="pre-main">
...
<main>
  ...
  {:else if page == "events"}
    <div class="event-pages">
      ...
      <img src="/UIProject_4/src/assets/PC_banner_v2.jpg">
    ...
    <div class="edit-button" on:click={() => go2editmode()}>
      <img style="position: relative; display: block; margin: auto; top: 8px;" src="/UIProject_4/src/assets/edit.png" width=30px>
    </div>
  {/if}
</main>
{:else}
...
<footer>
  ...
  <ul>
    <a href="https://www.facebook.com/cincinnatichildrensfans">
      <img width=25px src="/UIProject_4/src/assets/facebook.png">
    </a>
    <a href="https://www.instagram.com/cincychildrens/">
      <img width=25px src="/UIProject_4/src/assets/instagram.png">
    </a>
    <a href="https://x.com/CincyChildrens">
      <img width=40px src="/UIProject_4/src/assets/X.png">
    </a>
    <a href="https://www.pinterest.com/cincychildrens/">
      <img width=25px src="/UIProject_4/src/assets/pinterest.png">
    </a>
    <a href="https://www.youtube.com/user/CincinnatiChildrens">
      <img width=55px src="/UIProject_4/src/assets/youtube.png">
    </a>
  ...
  <div class="footer-end">
    <img src="/UIProject_4/src/assets/arc-pattern-lower-left.png">
    <p>
    ...
    <a href="">
      <img src="/UIProject_4/src/assets/Badge-ChildrensHospitals-Honor-Roll_Generic-year86.png">
    </a>
    <a href="">
      <img src="/UIProject_4/src/assets/bptw.png">
    </a>
    <img src="/UIProject_4/src/assets/arc-pattern-upper-right.png" style="position: relative; bottom: 200px;">
  </div>
</footer>
{#if infoShow == true}
  <ul class="nextsteps">
    ...
    <li>
      ...
      <section style="display: flex;">
        <img src="/UIProject_4/src/assets/edit-button.png">
